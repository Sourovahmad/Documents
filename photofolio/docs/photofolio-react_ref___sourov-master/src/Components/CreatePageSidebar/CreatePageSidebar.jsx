...
const CreatePageSidebar = ({ setIsInsertMediaBar, setIsTextBar }) => {
    ...
    return (
        <div id="create-page-sidebar">
            ...
            <TextButton  setIsTextBar={setIsTextBar} setIsInsertMediaBar={setIsInsertMediaBar} icon={TEXT_IMAGE_ICON} clicked={clicked} setClicked={setClicked} id="grid_layout_button__" />
        </div>
    );
};
