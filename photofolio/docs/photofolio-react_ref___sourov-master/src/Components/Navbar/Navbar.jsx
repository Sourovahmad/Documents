        ...
        <>
            <nav className="navbar MainNavbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    ...
                    <button onClick={()=> setIsNavbarShow(true)} className="navbar-toggler">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className={`collapse ${isNavbarShow?"navbar-show":""} navbar-collapse justify-content-between align-items-center`} id="navbarNav">
                        ...
                        <div onClick={() => setIsNavbarShow(false)} className="cancel-icon">
