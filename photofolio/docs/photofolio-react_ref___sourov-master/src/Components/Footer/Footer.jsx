    ...
    return (
        <footer id="footer" className="">
            ...
            <div className="footer-copyright">
                <div className="footer-container">
                    <div className="d-flex flex-wrap justify-content-center justify-content-start  w-100 align-items-center">
                        <div className=" logos">
                            <img src={TOKP_img} alt="" />
                            <img src={Yrk_Img} alt="" />
                        </div>
                        <div className="me-lg mb-2 mb-lg-0 -auto copyright-text">Copyright © 2020 - Tüm hakları saklıdır.</div>
                        <div className="icons d-flex ms-lg-auto">
                            <div className="icon">
